...
public class DataReportJob {
    ...
    List<ConfigHistoryItemVo> buildGroupItems(BatteryModuleGroupRealtime group) {
        ...
        addItem(items, "backupDuration", group.getBackupDuration());
        addItem(items, "bcapacity", group.getBcapacity());
        addItem(items, "capacity", group.getCapacity());
        addItem(items, "disChargeCapacity", group.getDisChargeCapacity());
        addItem(items, "disChargeDuration", group.getDisChargeDuration());
        addItem(items, "rippleVoltage", group.getRippleVoltage());
        addItem(items, "hydrogenConcentration", group.getHydrogenConcentration());
        addItem(items, "positiveinsulationResistance", group.getPositiveInsulationResistance());
        addItem(items, "negativeinsulationResistance", group.getNegativeInsulationResistance());
        addItem(items, "groundingBatteryUpperLimit", group.getGroundingBatteryUpperLimit());
        addItem(items, "groundingBatteryLowerLimit", group.getGroundingBatteryLowerLimit());
        addItem(items, "maxResistanceRateChangeBatteryNumber", group.getMaxResistanceRateChangeBatNum());
        addItem(items, "maxResistanceRateChange", group.getMaxResistanceRateChange());
