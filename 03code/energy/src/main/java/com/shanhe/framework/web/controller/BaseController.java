package com.shanhe.framework.web.controller;
...
import com.shanhe.common.utils.sql.SqlUtil;
import com.shanhe.framework.web.domain.AjaxResult;
import com.shanhe.framework.web.domain.AjaxResult.Type;
...
public class BaseController {
    ...
    protected void startPage() {
        ...
        if (StringUtils.isNotNull(pageNum) && StringUtils.isNotNull(pageSize)) {
            ...
            PageHelper.startPage(pageNum, pageSize, true, false, true).setOrderBy(orderBy);
        }
    }
