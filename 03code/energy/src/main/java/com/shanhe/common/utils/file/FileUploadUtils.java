...
import com.shanhe.common.exception.file.FileNameLengthLimitExceededException;
import com.shanhe.common.exception.file.FileSizeLimitExceededException;
import com.shanhe.common.exception.file.InvalidExtensionException;
...
public class FileUploadUtils {
    ...
    public static String upload(MultipartFile file) throws IOException {
        try {
            return upload(SysConst.getUploadPath(), file, MimeTypeUtils.DEFAULT_ALLOWED_EXTENSION);
        } catch (Exception e) {
    ...
    public static String getPathFileName(String uploadDir, String fileName) {
        int dirLastIndex = SysConst.profile.length() + 1;
