package com.shanhe.common.utils.poi;
...
import com.shanhe.common.utils.file.FileTypeUtils;
import com.shanhe.common.utils.file.FileUtils;
import com.shanhe.common.utils.file.ImageUtils;
import com.shanhe.common.utils.reflect.ReflectUtils;
import com.shanhe.common.utils.text.Convert;
import com.shanhe.framework.aspectj.lang.annotation.Excel;
import com.shanhe.framework.aspectj.lang.annotation.Excel.ColumnType;
import com.shanhe.framework.aspectj.lang.annotation.Excel.Type;
import com.shanhe.framework.aspectj.lang.annotation.Excels;
...
public class ExcelUtil<T>
{
    ...
    private Map<String, CellStyle> createStyles(Workbook wb)
    {
        ...
        Map<String, CellStyle> styles = new HashMap<>(7);
...
//        return DictUtils.getDictValue(dictType, dictLabel, separator);
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = SysConst.getDownloadPath() + filename;
