...
(
    ...
    battery_pack_status             INTEGER,
    bcapacity                       REAL,
    capacity                        REAL,
    backup_duration                 INTEGER,
    dis_charge_capacity             REAL,
    dis_charge_duration             INTEGER,
    battery_avg_temperature         REAL,
    battery_voltage_deviation       REAL,
    battery_voltage_range           REAL,
    residual_discharge_duration     INTEGER,
    ripple_voltage                  REAL,
    hydrogen_concentration          REAL,
    positive_insulation_resistance  REAL,
    negative_insulation_resistance  REAL,
    grounding_battery_upper_limit   INTEGER,
    grounding_battery_lower_limit   INTEGER,
    max_resistance_rate_change_bat_num INTEGER,
    max_resistance_rate_change      REAL,
    resistance_test_status          INTEGER,
    device_work_status              INTEGER,
    device_work_io_status           INTEGER,
